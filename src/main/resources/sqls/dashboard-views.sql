...
SELECT     { fn CONCAT(CONVERT(VARCHAR, TRG.YEAR), CONVERT(VARCHAR, TRG.PERIOD_NO)) } AS YEARPERIODNO,PS.AGE,PS.PERIODNAME, TRG.YEAR, TRG.PERIOD_NO, COUNT(SOH.SEQNO) AS QUOTEQTY, 
...
GROUP BY { fn CONCAT(CONVERT(VARCHAR, TRG.YEAR), CONVERT(VARCHAR, TRG.PERIOD_NO)) },PS.AGE,PS.PERIODNAME, TRG.YEAR, TRG.PERIOD_NO


-- X_VW_OS_SALEORDERS_BYPERIOD  
  SELECT     { fn CONCAT(CONVERT(VARCHAR, TRG.YEAR), CONVERT(VARCHAR, TRG.PERIOD_NO)) } AS YEARPERIODNO,PS.AGE,PS.PERIODNAME, TRG.YEAR, TRG.PERIOD_NO, COUNT(SOH.SEQNO) AS ORDERQTY, 
...
SELECT     { fn CONCAT(CONVERT(VARCHAR, TRG.YEAR), CONVERT(VARCHAR, TRG.PERIOD_NO)) } AS YEARPERIODNO,SOHTRN.AGE, TRG.YEAR, TRG.PERIOD_NO, COUNT(SOHTRN.SEQNO) AS INVOICEQTY, 
                      ...
                      AS NOOFWORKINGDAYS
FROM         dbo.X_Targets AS TRG LEFT OUTER JOIN
                          (SELECT     TRN.TRANSDATE,TRN.AGE, TRN.SEQNO, TRN.SUBTOTAL, SOH.X_GP
                            FROM          dbo.SALESORD_HDR AS SOH INNER JOIN
...
GROUP BY { fn CONCAT(CONVERT(VARCHAR, TRG.YEAR), CONVERT(VARCHAR, TRG.PERIOD_NO)) },SOHTRN.AGE, TRG.YEAR, TRG.PERIOD_NO